...
var _ urlenc.URLValuesUnmarshaler = (*PubOnExtensionsReq)(nil)
...
// PubOnExtensionsReq implement urlenc.URLValuesUnmarshaler.
func (m *PubOnExtensionsReq) UnmarshalURLValues(prefix string, values url.Values) error {
	for key, vals := range values {
		if len(vals) > 0 {
			switch prefix + key {
			case "orgID":
