...
var _ json.Marshaler = (*PubOnExtensionsReq)(nil)
var _ json.Unmarshaler = (*PubOnExtensionsReq)(nil)
...
// PubOnExtensionsReq implement json.Marshaler.
func (m *PubOnExtensionsReq) MarshalJSON() ([]byte, error) {
	buf := &bytes.Buffer{}
	err := (&jsonpb.Marshaler{
		OrigName:     false,
		EnumsAsInts:  false,
...
// PubOnExtensionsReq implement json.Marshaler.
func (m *PubOnExtensionsReq) UnmarshalJSON(b []byte) error {
	return (&protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}).Unmarshal(b, m)
}
